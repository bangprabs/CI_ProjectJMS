        ...
        <div class="content-wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <div class="container-fluid table-responsive">
                    ...
                    <table class="table">
                     <tr><td>Nama Klien</td><td><?php echo $nama_klien; ?></td></tr>
                     <tr><td>Item Project</td><td><?php echo $details; ?></td></tr>
                     <tr><td>Project Name</td><td><?php echo $project_name; ?></td></tr>
                     <tr><td>Start Date</td><td><?php echo $start_date; ?></td></tr>
                     <tr><td>Duedate</td><td><?php echo $duedate; ?></td></tr>
                     <tr><td>Status</td><td><?php echo $status; ?></td></tr>
                     <tr><td>Update By</td><td><?php echo $last_update_by; ?></td></tr>
                     <tr><td>Update Time</td><td><?php echo $last_update_time; ?></td></tr>
                     <tr><td></td><td><a href="<?php echo site_url('spk') ?>" class="btn btn-default">Back</a></td></tr>
                 </table>
             </div>
         </div>
     </div>
