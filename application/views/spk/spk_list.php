                ...
                <div id="page-content-wrapper">
                    <div class="container-fluid table-responsive">
                        ...
                        <div class="row" style="margin-bottom: 10px">
                            ...
                            <div class="col-md-3 text-right">
                                <form action="<?php echo site_url('spk/index'); ?>" class="form-inline" method="get">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            {
                                                ?>
                                                <a href="<?php echo site_url('spk'); ?>" class="btn btn-default">Reset</a>
                                                <?php
                                            }
                                            ?>
                        ...
                        <table id="example1" class="table table-cell">
                            ...
                            foreach ($spk_data as $spk)
                            {
                                ...
                                <tr>
                                 ...
                                 <td style="font-size: 18px;"><?php echo $spk->nama_klien ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->details ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->project_name ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->start_date ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->duedate ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->status ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->last_update_by ?></td>
                                 <td style="font-size: 18px;"><?php echo $spk->last_update_time ?></td>
                                 <td style="text-align:center" width="200px;">
                                    <?php 
                                    echo anchor(site_url('spk/read/'.$spk->no_spk),'<i style="font-size:20px; margin-right:10px; color:#337ab7;" class="ion-eye" aria-hidden="true"></i>'); 
                                    echo anchor(site_url('spk/update/'.$spk->no_spk),'<i style="color: #5cb85c; margin-right:10px; font-size:20px;" class="fa fa-pencil-square" aria-hidden="true"></i>');  
                                    echo anchor(site_url('spk/print_spk/'.$spk->no_spk),'<i style="color: #e08e0b; margin-right:10; font-size:20px;" class="fa fa-print" aria-hidden="true"></i>');  
                                    echo anchor(site_url('spk/delete/'.$spk->no_spk),'<i style="color: #d9534f; margin-left:10px;  font-size:20px;" class="fa fa-trash" aria-hidden="true"></i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                    ?>
                                </td>
                            </tr>
                            <?php
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-bottom: 30px;">
                            ...
                            <?php echo anchor(site_url('spk/word'), 'Word', 'class="btn btn-primary"'); ?>
                        </div>
