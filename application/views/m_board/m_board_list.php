        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-4">
                        <?php echo anchor(site_url('m_board/create'),'Create', 'class="btn btn-primary"'); ?>
                    </div>
                    ...
                    <div class="col-md-3 text-right">
                        <form action="<?php echo site_url('m_board/index'); ?>" class="form-inline" method="get">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    {
                                        ?>
                                        <a href="<?php echo site_url('m_board'); ?>" class="btn btn-default">Reset</a>
                                        <?php
                                    }
                                    ?>
                ...
                <table id="example1" class="table table-cell" style="margin-bottom: 10px;">
                    ...
                    <?php
                    foreach ($m_board_data as $m_board)
                    {
                        ?>
                        <tr>
                         <td width="80px"><?php echo ++$start ?></td>
                         <td style="font-size: 20px;"><?php echo $m_board->pesan ?></td>
                         <td style="font-size: 20px;"><?php echo $m_board->author ?></td>
                         <td style="text-align:center" width="200px">
                            <?php 
                            echo anchor(site_url('m_board/read/'.$m_board->no),'<i style="font-size:20px; margin-right:10px; color:#337ab7;" class="ion-eye" aria-hidden="true"></i>'); 
                            echo anchor(site_url('m_board/update/'.$m_board->no),'<i style="color: #5cb85c; font-size:20px; margin-right:10px;" class="fa fa-pencil-square" aria-hidden="true"></i>'); 
                            echo anchor(site_url('m_board/delete/'.$m_board->no),'<i style="color: #d9534f; font-size:20px; margin-right:10px;" class="fa fa-trash" aria-hidden="true"></i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                            ?>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 30px;">
                    ...
                    <?php echo anchor(site_url('m_board/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                    <?php echo anchor(site_url('m_board/word'), 'Word', 'class="btn btn-primary"'); ?>
                </div>
