        ...
        <div class="content-wrapper">
            ...
            <aside class="main-sidebar">
                   ...
                   <div class="user-panel">
                    <div class="card hovercard">
                        ...
                        <div class="info">
                            ...
                            <div class="desc" style="color: #fff;"><?php $this->input->set_cookie('namauser', TRUE);?></div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(); ?>adminbackend/report_spk">
                    ...
                    <table id="example1" class="table">
                        ...
                        <tbody>
                            ...
                            foreach ($ticket as $tik) :
                                ...
                                <tr style="text-align: center;">
                                    <td><?php echo $i++ ?></td>
                                    <td style="text-align: center;"><?php echo $key['no_spk']; ?></td>
                                    <td style="text-align: center;"><a href="<?=base_url('spk/read/' . $key['no_spk'])?>" class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                    <td style="text-align: center;"><?php echo $tik['no_spk']; ?></td>
                                    <td style="text-align: center;"><a href="<?=base_url('ticket/read/' . $tik['no_spk'])?>" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                </tr>
                            <?php endforeach ; ?>
                        <?php endforeach ; ?>
                    </tbody>
