                    ...
                    <div class="container-fluid">
                        <div id="page-content-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="deskripsi" id="deskripsi" placeholder="Deskripsi"><?php echo $agenda['deskripsi']; ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="attenders" style="margin-right: 10px;">Attenders</label>
                                ...
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="attend[]" value="<?php echo $key['user_fullname']; ?>" checked="<?php in_array($key['user_fullname'], $dataEdit) ? true : false ?>" /><?php echo $key['user_fullname'] ;?>
                                </label>
                                <?php } ?>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status" placeholder="Status" value="<?php echo $agenda['status']; ?>" />
                                    ...
                                    <option name="reshedule">Reschedule</option>
                                </select>
                            </div>
