                ...
                <aside class="main-sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="active treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="<?php echo base_url(); ?>agenda"><i class="fa fa-circle-o"></i> Agenda</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                    ...
                    <div class="container-fluid">
                        <div id="page-content-wrapper">
                            ...
                            <table id="example1" class="table table-cell" style="margin-bottom: 10px">
                                ...
                                foreach ($agenda_data as $agenda)
                                {
                                    ...
                                    <tr>
                                     ...
                                     <td style="width:100px;font-size: 20px;"><?php echo $agenda->invited_by ?></td>
                                     <td style="width: 120px;font-size: 20px;"><?php echo $agenda->judul_agenda ?></td>
                                     <td style="width: 380px;font-size: 20px;"><?php echo $agenda->deskripsi ?></td>
                                     <td style="font-size: 20px;"><?php echo $agenda->tempat ?></td>
                                     <td style="font-size: 20px;"><?php echo $agenda->tanggal ?></td>
                                     <td style="font-size: 20px;"><?php echo $agenda->jam ?></td>
                                     <td style="width: 100px; font-size: 20px;"><?php echo $agenda->attenders ?></td>
                                     <td style="font-size: 20px;"><?php echo $agenda->status ?></td>
                                     <td style="text-align:center" width="150px">
                                        <?php 
                                        echo anchor(site_url('agenda/read/'.$agenda->no_agenda),'<i style="font-size:20px; margin-right:10px; color:#337ab7;" class="ion-eye" aria-hidden="true"></i>'); 
                                        echo anchor(site_url('agenda/update/'.$agenda->no_agenda),'<i style="color: #5cb85c; font-size:20px; margin-right:10px;" class="fa fa-pencil-square" aria-hidden="true"></i>'); 
                                        echo anchor(site_url('agenda/print_agenda/'.$agenda->no_agenda),'<i style="color: #e08e0b; margin-right:10; font-size:20px;" class="fa fa-print" aria-hidden="true"></i>');
                                        echo anchor(site_url('agenda/delete/'.$agenda->no_agenda),'<i style="color: #d9534f; font-size:20px; margin-left:10px;" class="fa fa-trash" aria-hidden="true"></i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                        ?>
                                    </td>
                                </tr>
                                <?php
                        ...
                        <div class="row">
                            <div class="col-md-6" style="margin-bottom: 30px;">
                                ...
                                <?php echo anchor(site_url('agenda/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                                <?php echo anchor(site_url('agenda/word'), 'Word', 'class="btn btn-primary"'); ?>
                            </div>
