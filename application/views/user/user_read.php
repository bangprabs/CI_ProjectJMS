...
<head>
    ...
    <link href="<?=base_url()?>assets/css/font-awesome.css" rel="stylesheet"></head>
                ...
                <div class="container-fluid"><br>
                    <div class="container table-responsive">
                        ...
                        <table class="table">
                         ...
                         <tr><td>Password</td><td><input type="password" class="form-control" name="password" id="password" placeholder="Password" style="width: 40%;" disabled="disabled" value="<?php echo $password; ?>" /></td></tr>
